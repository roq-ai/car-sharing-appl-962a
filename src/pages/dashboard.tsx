...
import { useRoqPlatformUserProfiles, useBookingCount, useFeedbackCount, useServiceRequestCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const feedbackStat = useFeedbackCount();

  const serviceRequestStat = useServiceRequestCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Feedbacks',
      result: feedbackStat?.data,
      isLoading: feedbackStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Service Requests',
      result: serviceRequestStat?.data,
      isLoading: serviceRequestStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
