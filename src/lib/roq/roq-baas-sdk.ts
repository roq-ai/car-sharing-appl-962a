...
import type { Prisma, booking, car, company, feedback, service_request, user } from './types';
...
interface Service_requestSDK {
  create: <
    T extends Prisma.service_requestCreateArgs,
    R extends CheckSelect<T, service_request, Prisma.service_requestGetPayload<T>>,
  >(
    data: Prisma.SelectSubset<T, Prisma.service_requestCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R | undefined>;

  createMany: <T extends Prisma.service_requestCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.service_requestCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.service_requestUpdateArgs, R extends Prisma.service_requestGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.service_requestUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R | undefined>;

  updateMany: <T extends Prisma.service_requestUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.service_requestUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.service_requestUpsertArgs, R extends Prisma.service_requestGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.service_requestUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R | undefined>;

  delete: <T extends Prisma.service_requestDeleteArgs, R extends Prisma.service_requestGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.service_requestDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R | undefined>;

  deleteMany: <T extends Prisma.service_requestDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.service_requestDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
  ...
  count: <T extends Prisma.service_requestCountArgs, R extends number>(
...
export class RoqBaasSdk {
  ...
  public service_request!: Service_requestSDK;
  ...
  private initSDK() {
    ...
    this.service_request = {
      create: async function createService_request<
        T extends Prisma.service_requestCreateArgs,
        R extends CheckSelect<T, service_request, Prisma.service_requestGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.service_requestCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/service_request/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyService_request<
        T extends Prisma.service_requestCreateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.service_requestCreateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/service_request/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateService_request<
        T extends Prisma.service_requestUpdateArgs,
        R extends Prisma.service_requestGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.service_requestUpdateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/service_request/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyService_request<
        T extends Prisma.service_requestUpdateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.service_requestUpdateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/service_request/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertService_request<
        T extends Prisma.service_requestUpsertArgs,
        R extends Prisma.service_requestGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.service_requestUpsertArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/service_request/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteService_request<
        T extends Prisma.service_requestDeleteArgs,
        R extends Prisma.service_requestGetPayload<T>,
      >(data: Prisma.SelectSubset<T, Prisma.service_requestDeleteArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/service_request/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManyService_request<
        T extends Prisma.service_requestDeleteManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.service_requestDeleteManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/service_request/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyService_request<
        T extends Prisma.service_requestFindManyArgs,
        R extends GetFindResult<Prisma.$service_requestPayload<DefaultArgs>, T>[],
      >(args?: Prisma.SelectSubset<T, Prisma.service_requestFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/service_request/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countService_request<T extends Prisma.service_requestCountArgs, R extends number>(
        args?: Prisma.SelectSubset<T, Prisma.service_requestCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/service_request/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountService_request<
        T extends Prisma.service_requestFindManyArgs,
        R extends GetFindResult<Prisma.$service_requestPayload<DefaultArgs>, T>[],
        C extends number,
      >(args?: Prisma.SelectSubset<T, Prisma.service_requestFindManyArgs>, options?: RequestOptions) {
        const { distinct, orderBy, where } = args || {};
        const [data, count] = await Promise.all([
          ctx.service_request.findMany(args, options),
          ctx.service_request.count(
            {
              orderBy,
              where,
            },
      ...
      findFirst: async function findFirstService_request<
        T extends Prisma.service_requestFindFirstArgs,
        R extends GetFindResult<Prisma.$service_requestPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.service_requestFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/service_request/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
